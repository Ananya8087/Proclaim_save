...
function enableCategoryLevel2() {
  const categoryLevel2Select = document.querySelector('#categoryLevel2');
  categoryLevel2Select.disabled = false;
  console.log('categoryLevel2 is now enabled');
}
...
// Event listener for categoryLevel1 selection change
document.querySelector('#categoryLevel1').addEventListener('change', function() {
  // Introduce a delay before enabling categoryLevel2
  setTimeout(enableCategoryLevel2, 2000); // 2000 milliseconds = 2 seconds delay
});
